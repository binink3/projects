...
def fm_past():
    ...
    manager_name_recieve = request.form['manager_name_give']
    target_fund_info = db.funds.find_one({'Status': "Active", 'fund_name':fund_name_recieve, 'manager_name': manager_name_recieve}, {'_id': 0}) ##id값은 가져오지 않겠다
